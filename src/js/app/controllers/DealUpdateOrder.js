 ...
 * 
 * 
 * @class DealUpdateOrderController
 * @namespace App
 * @extends Ember.ObjectController
 * @uses Ember.Validations.Mixin.Validator
 */
App.DealUpdateOrderController = App.AbstractControllers.DealFormController.extend({
    addOptionObersers: function(a) {
        console.log("DealUpdateOrderController addOptionObersers");
